                ...
                <div class="col-lg-9">
                    <div class="navigation">
                        <ul class="list-inline-item">
                            ...
                            <li class="list-inline-item"><a href="{{route('shop.index')}}">Shop</a></li>
                            <li class="list-inline-item">{{$categoryName}}</li>
                        </ul>
                    </div>
                    ...
                    <div class="shop_content">
                        ...
                        <div class="shop_bar clearfix">
                            <div class="shop_product_count"><span>{{$products->count()}}</span> products found @if($categoryName!="Featured") on <strong>{{$categoryName}}</strong> category @endif</div>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li class="shop_sorting_button"><a href="{{route('shop.index', ['category'=>request('category'), 'sortBy' => 'low_high'])}}">Low to High</a> </li>
                                            <li class="shop_sorting_button"><a href="{{route('shop.index', ['category'=>request('category'), 'sortBy' => 'high_low'])}}">High to Low</a> </li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <!-- Product Item -->
                                    <div class="product_item is_new">
                                        ...
                                        <div class="product_content">
                                            ...
                                            <div class="product_name"><div><a href="{{route('shop.productShow', $product->slug)}}" tabindex="0">{{$product->name}}</a></div></div>
                                        </div>
